...
# Begin Custom Build - Performing registration
OutDir=.\DebugU
TargetPath=.\DebugU\test.exe
InputPath=.\DebugU\test.exe
SOURCE="$(InputPath)"
...
TargetPath=.\ReleaseMinSize\test.exe
InputPath=.\ReleaseMinSize\test.exe
SOURCE="$(InputPath)"
...
TargetPath=.\ReleaseMinDependency\test.exe
InputPath=.\ReleaseMinDependency\test.exe
SOURCE="$(InputPath)"
...
TargetPath=.\ReleaseUMinSize\test.exe
InputPath=.\ReleaseUMinSize\test.exe
SOURCE="$(InputPath)"
...
TargetPath=.\ReleaseUMinDependency\test.exe
InputPath=.\ReleaseUMinDependency\test.exe
SOURCE="$(InputPath)"
